...
params.fulltable = "/home/nurgling/PhD/gonya_phylo/test_script-rewrite-w-BUSCO2/huge-script-test/run_*/full_table_*" ${params.fulltable}
params.hmmerlib = "/home/nurgling/Programs/busco/protists_ensembl/hmms/" ${params.hmmerlib}
params.hmmerbin = "/home/nurgling/Programs/hmmer-3.1b2-linux-intel-x86_64/binaries" ${params.hmmerbin}
params.protseqs = "/home/nurgling/PhD/gonya_phylo/test_script-rewrite-w-BUSCO2/huge-script-test/run_*/translated_proteins" ${params.protseqs}
params.transcriptomes = 2 ${params.transcriptomes}
params.reaseq = "/home/nurgling/Programs" ${params.reaseq}
